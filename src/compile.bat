...
:: set common_flags=/std:clatest /external:W0 /external:I src\libs 
...
:: set ggpo_link_flags=ggpo.lib Winmm.lib
:: cl.exe src/main.c %common_flags% %vulkan_flags% /link /out:game.exe %sdk_link_flags% %vulkan_link_flags% %imgui_link_flags% %tracy_link_flags% %ggpo_link_flags%
